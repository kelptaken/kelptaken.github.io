function t228__init(recid) {
  ...
  var fixedBlock =
    mobile.css("position") === "fixed" && mobile.css("display") === "block";
  setTimeout(function () {
    ...
    el.find(
      ".t-menu__link-item:not(.t-menusub__target-link):not(.tooltipstered):not(.t794__tm-link)"
    ).on("click", function () {
      if (
        $(this).is(
...
function t228_checkAnchorLinks(recid) {
  var el = $("#rec" + recid);
  if ($(window).width() > 980) {
    var t228_navLinks = el.find(
      ".t228__list_item a:not(.tooltipstered)[href*='#']"
    );
...
function t228_checkOverflow(recid) {
  ...
  if (menu.css("position") === "fixed") {
    ...
    menu[0].style.setProperty(
      "height",
      winHeight - $(".t228__mobile_container").outerHeight(!0) + "px",
      "important"
    );
  }
}
  ...
  $(window).scroll(function () {
    ...
    if (t228_lastCall && t228_now < t228_lastCall + t228_interval) {
      ...
      t228_timeoutId = setTimeout(function () {
        ...
        t228_clickedSectionId = t228_highlightNavLinks(
          t228_navLinks,
          t228_sections,
          t228_sectionIdTonavigationLink,
          t228_clickedSectionId
...
function t228_highlightNavLinks(
  ...
  if (
    t228_sections.length !== 0 &&
    t228_clickedSectionId === null &&
    t228_sections[t228_sections.length - 1].offset().top >
      t228_scrollPosition + 300
  ) {
    t228_navLinks.removeClass("t-active");
    return null;
  }
  $(t228_sections).each(function (e) {
    ...
    if (
      t228_scrollPosition + 300 >= t228_sectionTop ||
      (t228_sections[0].attr("id") == t228_id &&
        t228_scrollPosition >= $(document).height() - $(window).height())
    ) {
...
function t718_onSuccess(t718_form) {
  ...
  if (
    t718_targetOffset > $(window).scrollTop() ||
    $(document).height() - t718_inputsBottom < $(window).height() - 100
  ) {
